...
class Animals(db.Model):
    __tablename__ = 'animalsNew'

    id = db.Column(db.Integer, primary_key=True)
    s_class = db.Column(db.String(64))
    species = db.Column(db.String(64))
    scientificname = db.Column(db.String(64))
    countrycode = db.Column(db.String(64))
    decimalLatitude = db.Column(db.String(64))
    decimalLongitude = db.Column(db.String(64))
    eventdate = db.Column(db.String(64))
    year = db.Column(db.String(64))
    taxonkey = db.Column(db.String(64))


    def __repr__(self):
        return '<Animals %r>' % (self.s_class)
